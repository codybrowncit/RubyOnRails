...
class BakersControllerTest < ActionController::TestCase
  ...
  test "should create baker" do
    assert_difference('Baker.count') do
      post :create, baker: { gluten_free: @baker.gluten_free, name: @baker.name, zip_code: @baker.zip_code }
    end
  ...
  test "should update baker" do
    patch :update, id: @baker, baker: { gluten_free: @baker.gluten_free, name: @baker.name, zip_code: @baker.zip_code }
    assert_redirected_to baker_path(assigns(:baker))
  end
